...
export const category = {
  page: {
    ...
    subtitle: 'Manage data categories, organize and sort resource nodes',
  ...
  table: {
    ...
    clickToView: 'Click to view all data units in this category',
  ...
  empty: {
    ...
    description: 'No categories created yet. Click "Create Category" to create your first category',
  ...
  form: {
    ...
    sortOrder: {
      ...
      hint: 'Lower sort values appear first in list',
    },
    status: {
      label: 'Status',
      active: 'Enabled',
