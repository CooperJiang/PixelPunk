...
export const dashboard = {
  ...
  stats: {
    ...
    quotas: {
      ...
      description: {
        healthy: 'Resources sufficient, use with peace of mind',
        warning: 'Resource usage moderate, suggest regular cleanup of unnecessary content',
        danger: 'Resource usage critical, please clean up content or contact admin for expansion',
      },
    },
  },
  messages: {
    ...
    markReadFailed: 'Failed to mark as read, please retry',
  },
  errors: {
  ...
  recentUploads: {
    ...
    toast: {
      ...
      copySuccess: 'Copied {count} data unit links',
